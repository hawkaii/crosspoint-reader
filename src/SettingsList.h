...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Toggle(StrId::STR_WALLPAPER_SYNC, &CrossPointSettings::wallpaperSyncEnabled,
                            "wallpaperSyncEnabled", StrId::STR_CAT_DISPLAY),
        SettingInfo::String(StrId::STR_WALLPAPER_SYNC_URL, &SETTINGS.wallpaperSyncUrl[0],
                            sizeof(SETTINGS.wallpaperSyncUrl), "wallpaperSyncUrl", StrId::STR_CAT_DISPLAY),
